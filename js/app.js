(function () {
  ...
  function drawLegend(data) {
    ...
    data.features.forEach(function (school) {
      ...
      for (let grade in school.properties) {
        ...
        //console.log(school.properties[grade])
        if (+value && grade != "TOTAL") {
    ...
    //console.log(largeDiameter.toFixed())
  ...
  function updateGrade(currentGrade) {
    ...
    $("#grade span").innerHTML = currentGrade;

  } //end updateGrade

  function retrieveInfo(boysLayer, currentGrade) {

    //console.log("BOYS LAYER", boysLayer)
    ...
    boysLayer.on("mouseover", function (e) {
      ...
      // console.log("LOOK HERE", props) //logs on mouseover
      // console.log("PROP TEST", props.COUNTY) // logs on mouseover
